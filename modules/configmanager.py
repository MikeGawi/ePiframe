...
class configmanager:
	...
	def __init__ (self, path:str):
		...
		self.__SETTINGS = [
			...
			configprop('interval_max_mult', self, dependency='interval_mult', prop_type=configprop.INTEGER_TYPE),
			...
			configprop('image_width', self, prop_type=configprop.INTEGER_TYPE),
			configprop('image_height', self, prop_type=configprop.INTEGER_TYPE),
			...
			configprop('no_photos', self, notempty=False, prop_type=configprop.INTEGER_TYPE),
			...
			configprop('font', self, dependency='show_weather', prop_type=configprop.INTEGER_TYPE),
