...
* Install PIPs:
```
sudo -H pip3 install -I requests python-dateutil 'configparser>=5.0.0' pandas==1.2.0 numpy==1.20 spidev==3.5 image pillow==8.4.0 pyTelegramBotAPI==4.1.1 'flask>=2.0.2' flask-wtf==1.0.0 flask-login==0.5.0 'wtforms>=3.0.0'
